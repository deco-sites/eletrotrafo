  ...
  return (
    <>
      <label class="indicator" for={MINICART_DRAWER_ID} aria-label="open cart">
        <span
          id={id}
          class={`hidden indicator-item badge badge-sm bg-white border-white text-primary [.is-homepage:not(.is-scrolled)_&]:bg-primary [.is-homepage:not(.is-scrolled)_&]:border-primary [.is-homepage:not(.is-scrolled)_&]:text-white`} 
        />
